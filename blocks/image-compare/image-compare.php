...
class ImageCompare extends Block
{
    ...
    {
        parent::__construct([
            'slug' => 'sp-block-image-compare',
            'name' => __('Image Compare', 'sitepilot'),
            'fields' => [
                Image::make(__('Image 1', 'sitepilot'), 'img_1')
                    ->default_value('https://picsum.photos/1024/600'),

                ImageSize::make(__('Image Size', 'sitepilot'), 'img_1_size'),

                Image::make(__('Image 2', 'sitepilot'), 'img_2')
                    ->default_value('https://picsum.photos/1024/600'),

                ImageSize::make(__('Image Size', 'sitepilot'), 'img_2_size')
            ],
