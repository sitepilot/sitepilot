...
namespace Sitepilot\Modules\Extend;

use Sitepilot\Module;

/**
 * @property \Sitepilot\Modules\Extend\PowerPack $power_pack
 * @property \Sitepilot\Modules\Extend\UltimateAddons $ultimate_addons
 */
class BeaverBuilder extends Module
{
    ...
    public function __construct()
    {
        ...
        $modules = [
            'power_pack' => \Sitepilot\Modules\Extend\PowerPack::class,
            'ultimate_addons' => \Sitepilot\Modules\Extend\UltimateAddons::class
        ];
